...
\answerbox[18cm]{The system will be made up of four components: the Qt-based 2D Game Interface, the C++/OOP Application and Game Logic, the DSA & Algorithm Engine, and the SQLite Database.
